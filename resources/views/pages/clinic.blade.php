...
<head>
    ...
    <title>Klinik - Hanglekiu Dental Specialist</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18]">
    ...
    <main class="page-wrap">
        <section class="page-hero">
            <h1 class="page-title">Klinik</h1>
            <p class="page-desc">Informasi singkat tentang klinik, layanan, dan kenyamanan perawatan di Hanglekiu Dental Specialist.</p>
        </section>

        <section class="content-card">
            <h2>Tentang Klinik</h2>
            <p>Halaman ini bisa diisi profil klinik (alamat, jam operasional, fasilitas, dan kontak). Jika kamu kirim datanya, aku rapihin susunannya.</p>
        </section>
    </main>
</body>
</html>

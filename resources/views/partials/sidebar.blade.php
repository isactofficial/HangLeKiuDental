...
<style>
    ...
    .hamburger{display:none;position:fixed;left:12px;top:12px;z-index:220;background:#1a365d;color:#fff;border-radius:8px;width:44px;height:44px;border:none;align-items:center;justify-content:center;cursor:pointer}

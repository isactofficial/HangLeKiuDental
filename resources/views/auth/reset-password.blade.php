...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .form-group input:focus{border-bottom-color:var(--action)}
        ...
        .submit-btn:hover{filter:brightness(.96);box-shadow:0 6px 18px rgba(0,0,0,0.08)}

        .back-link{text-align:center;margin-top:18px}
        .back-link a{color:var(--action);text-decoration:none;font-size:14px}
        ...
        .alert-danger p{margin:0;text-align:left}
    </style>
</head>
<body>
    <div class="container">
